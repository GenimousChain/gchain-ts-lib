 ...
 *
 * @example
 * import { SafeMath } from "gchain-ts-lib/src/safemath";
 */
export namespace SafeMath {
	...
	function mul(a: u64, b: u64): u64 {
		...
		var c = a * b;
		gchain_assert(c / a == b, `${a} mulitiply ${b} overflow`);
		return c;
	}
	...
	function div(a: u64, b: u64): u64 {
		gchain_assert(b != 0, `Can't dividing by 0`);
		return a / b;
	}
	...
	function sub(a: u64, b: u64): u64 {
		gchain_assert(b <= a, `Minuend is greater than subtrahend`);
		return a - b;
	}
	...
	function add(a: u64, b: u64): u64 {
		var c = a + b;
		gchain_assert(c >= a, `SafeMath add failed`);
		return c;
	}
