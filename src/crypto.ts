...
function charcode_to_digital(char: i32): u8 {
    ...
    if (char >= CHAR0 && char <= CHAR9) {
        ...
        gchain_assert(false, "unknown character for hexadecimal convert.");
    }
    return ret;
}
...
function from_hex(hexStr: string, buffer: ArrayBuffer, bufferSize: u32): void {
    ...
    gchain_assert(targetSize == bufferSize, "Crypto.fromString failed: hexadecimal string length is mismatch for target crypto algorithm.");
 ...
 *
 * @example
 * import { SHA1 } from "gchain-ts-lib/src/crypto";
 */
 ...
 *
 * @example
 * import { SHA256 } from "gchain-ts-lib/src/crypto";
 */
 ...
 *
 * @example
 * import { SHA512 } from "gchain-ts-lib/src/crypto";
 */
 ...
 *
 * @example
 * import { Ripemd160 } from "gchain-ts-lib/src/crypto";
 */
 ...
 *
 * @example
 * import { assert_sha1 } from "gchain-ts-lib/src/crypto";
 */
 ...
 *
 * @example
 * import { assert_sha256 } from "gchain-ts-lib/src/crypto";
 */
 ...
 *
 * @example
 * import { assert_sha512 } from "gchain-ts-lib/src/crypto";
 */
 ...
 *
 * @example
 * import { assert_ripemd160 } from "gchain-ts-lib/src/crypto";
 */
...
export class MerkleProof {
    ...
    static getMerkleProof(block_number: u32, trx_id: string): MerkleProof {
        ...
        if (ret != 0) {
            ...
            gchain_assert(ret == 0, "Read MerkleProof failed: block_number =  " + intToString(block_number) +", trx_id = " + trx_id);
        }
