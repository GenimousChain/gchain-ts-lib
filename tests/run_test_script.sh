...
clu="${HOME}/Public/gchain-core/build/programs/clgchain/clgchain --url http://pioneer.natapp1.cc --wallet-url http://127.0.0.1:8900"
...
# ./clgchain --url http://gchain.natapp1.cc set account permission autotest1 active '{"threshold": 1,"keys": [{"key":"UTR8573kkPXFNqpzEUjFAjmvZeXLLBanhSj5Rd4g5sBhQDnCDqBaW","weight": 1}],"accounts": [{"permission":{"actor":"autotest1","permission":"utrio.code"},"weight":1}]}' owner -p autotest1
